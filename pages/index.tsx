    ...
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <div
          ...
          hover:bg-teal-500 active:bg-yellow-400 focus:bg-red-400
         "
        >
          Checkout
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              <button className="w-5 h-5 rounded-full bg-yellow-300 hover:ring-2 ring-offset-2 ring-yellow-300 transition-all" />
              <button className="w-5 h-5 rounded-full bg-indigo-500 hover:ring-2 ring-offset-2 ring-indigo-300 transition-all" />
              <button className="w-5 h-5 rounded-full bg-teal-300 hover:ring-2 ring-offset-2 ring-teal-300 transition-all" />
            </div>
